  ...
  <el-dialog :title="dialogTitle"  :visible.sync="dialogFormVisible" size="mini"   v-show="dialogFormVisible" class="transition-box">
    ...
    <el-form :inline="true" :model="xstudent" class="demo-form-inline" size="mini" ref="xstudent" >
      ...
      <el-form-item label="学号" prop="snumber" 
       ...
       >
        <el-input v-model="xstudent.snumber" placeholder="精确查询:如2017010xxx" ></el-input>
      </el-form-item>
      ...
      >
        <el-input v-model="xstudent.name" placeholder="模糊查询:输入名字"  ></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="warning" @click="back()">列表</el-button>
      </el-form-item>
...
export default {
    ...
    methods: {
      ...
      onSubmit(ruleForm){
        if((this.xstudent.snumber!='' && this.xstudent.name =='')||(this.xstudent.snumber!='' && this.xstudent.name !='')){
